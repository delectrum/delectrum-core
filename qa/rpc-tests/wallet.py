...
#   c) node1 mines 32 blocks, so now node 0 has 60001dltr, node 1 has 4250dltr, node2 has none.
#   d) node0 sends 601 dltr to node2, in two transactions (301 dltr, then 300 dltr).

...
In order to support loading of multiple wallets in delectrum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is delectrum.cpp.
...
Changes to delectrum.cpp
----------------------
delectrum.cpp is the entry point into delectrum-qt, and as such, will require some minor modifications to provide hooks for

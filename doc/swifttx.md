...
This mechanism has been integrated into Bitcore-Node-Delectrum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Delectrum-Project/insight-api-delectrum#web-socket-api](https://github.com/Delectrum-Project/insight-api-delectrum#web-socket-api) 
* API: [https://github.com/Delectrum-Project/insight-api-delectrum#swifttx-transactions](https://github.com/Delectrum-Project/insight-api-delectrum#swifttx-transactions) 
...
By default, the Delectrum Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Delectrum Core daemon:

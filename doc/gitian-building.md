...
*Setup instructions for a gitian build of Delectrum using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Delectrum
...
- [Building Delectrum](#building-delectrum)
...
Clone the git repositories for delectrum and gitian and then checkout the delectrum version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/delectrum-crypto/delectrum.git
cd delectrum
...
Follow the instructions in [doc/release-process.md](release-process.md) in the delectrum repository
...
To build Delectrum (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the delectrum repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/delectrum/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/delectrum-crypto/delectrum
...
For example:
```bash
URL=https://github.com/crowning-/delectrum.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit delectrum=${COMMIT} --url delectrum=${URL} ../delectrum/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit delectrum=${COMMIT} --url delectrum=${URL} ../delectrum/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit delectrum=${COMMIT} --url delectrum=${URL} ../delectrum/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/delectrum-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/delectrum-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/delectrum-build.assert
```
...
[delectrum/gitian.sigs](https://github.com/delectrum-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.

Contributing to Delectrum Core
============================

The Delectrum Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Delectrum Core project, and is not to be
confused with overall Delectrum Network Protocol consensus changes.

Whether a pull request is merged into Delectrum Core rests with the project merge
...
Patches that change Delectrum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Delectrum consensus, it must have been
...
The project leader is the release manager for each Delectrum Core release.

/* src/config/delectrum-config.h.  Generated from delectrum-config.h.in by configure.  */
/* src/config/delectrum-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DLTR_CONFIG_H

#define DLTR_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.delectrum.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Delectrum Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Delectrum Core 3.0.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "delectrum"

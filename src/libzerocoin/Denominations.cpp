...
CoinDenomination IntToZerocoinDenomination(int64_t amount)
{
    ...
    switch (amount) {
        ...
        case 100000: denomination = CoinDenomination::ZQ_ONE_HUNDRED_THOUSAND; break;
        case 1000000: denomination = CoinDenomination::ZQ_ONE_MILLION; break;
        case 10000000: denomination = CoinDenomination::ZQ_TEN_MILLION; break;
    default:
...
int64_t ZerocoinDenominationToInt(const CoinDenomination& denomination)
{
    ...
    case CoinDenomination::ZQ_ONE_HUNDRED_THOUSAND: Value = 100000; break;
    case CoinDenomination::ZQ_ONE_MILLION: Value = 1000000; break;
    case CoinDenomination::ZQ_TEN_MILLION: Value = 10000000; break;
    default:
        // Error Case
        Value = 0; break;
    }
...
// use case: converting Dltr to zDlt without user worrying about denomination math themselves

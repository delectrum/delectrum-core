...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Delectrum Core delectrum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  delectrum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded delectrum transaction") + "\n" +
                               "  delectrum-tx [options] -create [commands]   " + _("Create hex-encoded delectrum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded delectrum transaction

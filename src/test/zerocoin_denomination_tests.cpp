...
//translation from delectrum quantity to zerocoin denomination
BOOST_AUTO_TEST_CASE(amount_to_denomination_test)
{
    ...
    CAmount amount1 = 10000000 * COIN;
    BOOST_CHECK_MESSAGE(AmountToZerocoinDenomination(amount1) == ZQ_TEN_MILLION, "For 10000000*COIN denomination should be ZQ_ONE");

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Delectrum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Delectrum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and delectrum: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDLT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Delectrum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Delectrum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Delectrum"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Delectrum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Delectrum addresses"));
    ...
    openAction->setStatusTip(tr("Open a Delectrum: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Delectrum Core help message to get a list with possible Delectrum command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Delectrum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Delectrum network", "", count));
}
...
{
    QString strTitle = tr("Delectrum Core"); // default title

...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Delectrum Core"),
     ...
     * override -datadir in the delectrum.conf file in the default data directory
     * (to be consistent with delectrumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

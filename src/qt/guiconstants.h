...
/* Delectrum GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Delectrum"
#define QAPP_ORG_DOMAIN "delectrum.org"
#define QAPP_APP_NAME_DEFAULT "Delectrum-Qt"
#define QAPP_APP_NAME_TESTNET "Delectrum-Qt-testnet"

...
/** Utility functions used by the Delectrum Qt UI.
 */
namespace GUIUtil
{
...
// Render Delectrum addresses in monospace font
...
// Parse "delectrum:" URI into recipient object, return true on successful parsing

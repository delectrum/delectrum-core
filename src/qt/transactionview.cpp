 ...
 */
    ...
    typeWidget->addItem(tr("Received Dltr from zDlt"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDlt"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDlt));
